...
<body>
    ...
    <x-form.alert name="error" class="alert-error"></x-form.alert>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm @if($plan->featured) border-primary @endif">
                        ...
                        <div class="card-body">
                            ...
                            <input type="hidden" name="period" value="3"> 
                                ...
                                @if($plan->name == 'Free Plan')Sign in for free @else Subscribe @endif
                            </button>
                        </form>
                        </div>
                    </div>
        ...
        <footer class="pt-4 my-md-5 pt-md-5 border-top">
            <div class="row">
                <div class="col-12 col-md">
                    <img class="mb-2" src="/docs/5.3/asset/brand/bootstrap-logo.svg" alt=""
                        width="24" height="19">
